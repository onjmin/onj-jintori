...
const PORT = parseInt(process.env.PORT) || 2053;
...
try {
    if (process.env.ADMIN_PASSWORD) {
        ...
        ADMIN_ACCOUNTS = [{ username: 'admin', passwordHash: hash }];
        console.log('[CONFIG] Admin credentials loaded from ADMIN_PASSWORD env var');
    } else if (fs.existsSync(ADMIN_CREDENTIALS_FILE)) {
        ...
        throw new Error('admin-credentials.json not found and ADMIN_PASSWORD not set');
    }
} catch (e) {
